...
#ifndef __STLViewerHandlers_i_h__
#define __STLViewerHandlers_i_h__
...
EXTERN_C const IID IID_IPreview;
    ...
    MIDL_INTERFACE("7E9EFDA0-DB6E-4611-84F2-1FC8E459C4DB")
...
EXTERN_C const IID IID_IThumbnail;
    ...
    MIDL_INTERFACE("7FD06204-B970-42EB-A8C4-4C592B7FDAEA")
...
EXTERN_C const IID IID_ISearch;
    ...
    MIDL_INTERFACE("231329B8-AA89-4AB6-A021-73EB61B06B04")
...
#ifndef __STLViewerHandlersLib_LIBRARY_DEFINED__
#define __STLViewerHandlersLib_LIBRARY_DEFINED__

/* library STLViewerHandlersLib */
/* [version][uuid] */ 


EXTERN_C const IID LIBID_STLViewerHandlersLib;

EXTERN_C const CLSID CLSID_Preview;

#ifdef __cplusplus

class DECLSPEC_UUID("13B23B27-D454-49B1-97B2-6E6F9C118AAD")
Preview;
#endif
...
class DECLSPEC_UUID("800809D9-32ED-4992-845D-A1C435386609")
Thumbnail;
#endif
...
class DECLSPEC_UUID("DAA928BA-4465-4BEE-93E8-A1713B326273")
Search;
#endif
#endif /* __STLViewerHandlersLib_LIBRARY_DEFINED__ */
