...
//// 四面体类
//class AFX_EXT_CLASS CElement :public ELEMENT
//{
//public:
//	CElement();
//	CElement(const CTriface& iele1, const CTriface&  iele2, const CTriface& iele3, const CTriface&  iele4);
//	CElement(const CTriface*);
//	~CElement();
//
//};
//
//// 三角面类
//class AFX_EXT_CLASS CTriface :public TRIFACE
//{
//public:
//	CTriface();
//	CTriface(const CPoint3D& inode1, const CPoint3D& inode2, const CPoint3D& inode3 );
//	CTriface(const CPoint3D*);
//	CTriface(TRIFACE p);
//	~CTriface();
//public:
//	CTriface operator=(const TRIFACE&) const;
//
//};
...
class AFX_EXT_CLASS CPoint4D :public POINT4D
{
public:
	CPoint4D();
	CPoint4D(double ix,double iy,double iz,double it);
	CPoint4D(const double*);
	CPoint4D(POINT4D p);
	~CPoint4D();
