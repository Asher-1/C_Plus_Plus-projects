make QUIET_MAKE=1 TARGET=NEHALEM DYNAMIC_ARCH=1 HOSTCC=gcc NUM_THREADS=64 BINARY=64 CC=x86_64-w64-mingw32-gcc FC=x86_64-w64-mingw32-gfortran
 ...
 OpenBLAS build complete.
  ...
  Library Name     ... libopenblasp-r0.2.8.a (Multi threaded; Max num-threads is 64)
...
│   ├── libopenblas.def        The DEF file for DLL.
│   ├── libopenblas.dll        The shared library for Visual Studio and GCC.
│   ├── libopenblas.exp        The export library for Visual Studio.
│   └── libopenblas.lib        The import library for Visual Studio.
└── readme.txt
