...
int check_mesh(TriMesh *in)
{
	...
	CString temp1;
	temp1.Format("Found %d funny vertices... Done.\n", num_bad_verts);
	str=str+temp1;
	if (num_bad_verts) 
	{
	...
	temp1.Format("Found %d bogus triangles... Done.\n", num_bad_faces);
	str=str+temp1;
	...
	// ordering.
	str=str+"Looking for duplicate faces... \n";
	...
	temp1.Format("Found %d duplicates and fins... Done.\n", nuked);
	str=str+temp1;
	...
	str=str+"Checking for non-manifold topology... \n";
	...
	//-------------------------------------输出检查结果到文件---------------------------------------------------
	CStdioFile file;
	file.Open("..\\shoeCADlog.txt", CFile::modeCreate|CFile::modeWrite|CFile::typeText);
